        ...
        <div class="max-width">
            ...
            <div class="about-content">
                <div class="column left">
                    <img src="{{asset('frontend')}}/images/profile-1.jpeg" alt="">
                </div>
    ...
    <section class="teams" id="teams">
        <div class="max-width">
            ...
            <div class="carousel owl-carousel">
                ...
                <div class="card">
                    <div class="box">
                        <img src="{{asset('frontend')}}/images/profile-2.jpeg" alt="">
                        <div class="text">Someone name</div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="{{asset('frontend')}}/images/profile-3.jpeg" alt="">
                        <div class="text">Someone name</div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="{{asset('frontend')}}/images/profile-4.jpeg" alt="">
                        <div class="text">Someone name</div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
                <div class="card">
                    <div class="box">
                        <img src="{{asset('frontend')}}/images/profile-5.jpeg" alt="">
                        <div class="text">Someone name</div>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
                    </div>
                </div>
